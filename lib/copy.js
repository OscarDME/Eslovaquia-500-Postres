...
export const copy = {
  ...
  benefits: {
    ...
    items: [
      ...
      { icon: "📖", title: "Krok za krokom pri príprave" },
    ],
  },
  ...
  categories: {
    kicker: "Bez toho, aby ťa to omrzelo",
    ...
    groups: [
      ...
      {
        title: "100 slávnych koláčov z TikToku",
        items: [
          { src: "/preview/1-7.webp", alt: "Koláč z TikToku 1" },
          { src: "/preview/2-6.webp", alt: "Koláč z TikToku 2" },
          { src: "/preview/3-5-1.webp", alt: "Koláč z TikToku 3" },
          { src: "/preview/4-3.webp", alt: "Koláč z TikToku 4" },
        ],
      },
      {
  ...
  guarantee: {
    kicker: "Bez rizika",
    headline: "VYSKÚŠAJ BEZ RIZIKA — 60-dňová bezpodmienečná záruka.",
    body: "Máš 60 dní na to, aby si ich vyskúšala. Ak ťa recepty nepresvedčia, vrátim ti peniaze do posledného centu. Bez komplikácií. Bez zbytočných otázok.",
    alt: "Pečať pre 60-dňovú bezpodmienečnú záruku",
